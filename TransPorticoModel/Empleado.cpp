...
Empleado::Empleado( String^ DNI, String^ Nombre, String^ ApellidoPat, String^ ApellidoMat, int Edad, String^ Genero, String^ Telefono, String^ Contrasena, String^ Tipo,int Sueldo, String^ EstadoContrato) :Persona(DNI, Nombre, ApellidoPat, ApellidoMat, Edad, Genero, Telefono, Contrasena, Tipo) {
	this->Sueldo = Sueldo;
...
String^ Empleado::GetTipo_Empleado() {
	return this->Tipo;
};
void Empleado::SetTipo_Empleado(String^ Contrasena) {
	this->Tipo = Tipo;
};
