...
namespace TransPorticoView {
	...
	/// <summary>
	/// Resumen de PPAdministradorMantenimientoBuses
	/// </summary>
	public ref class PPAdministradorMantenimientoBuses : public System::Windows::Forms::Form
	{
	public:
		PPAdministradorMantenimientoBuses(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(PPAdministradorMantenimientoBuses::typeid));
