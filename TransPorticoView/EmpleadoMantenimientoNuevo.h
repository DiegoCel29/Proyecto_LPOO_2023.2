...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->B_Cancelar->Click += gcnew System::EventHandler(this, &EmpleadoMantenimientoNuevo::B_Cancelar_Click_1);
			// 
			// B_Crear
			// 
			...
			this->B_Crear->Click += gcnew System::EventHandler(this, &EmpleadoMantenimientoNuevo::B_Crear_Click_1);
			// 
			// EmpleadoMantenimientoNuevo
			// 
			...
			this->Text = L"EmpleadoMantenimientoNuevo";
