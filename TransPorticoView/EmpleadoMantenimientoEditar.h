...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->CB_Genero->SelectedIndexChanged += gcnew System::EventHandler(this, &EmpleadoMantenimientoEditar::CB_Genero_SelectedIndexChanged);
			// 
			// L_Contrasena
			// 
			...
			this->L_Contrasena->Click += gcnew System::EventHandler(this, &EmpleadoMantenimientoEditar::L_Contrasena_Click);
			// 
			// TB_Contrasena
			// 
			...
			this->TB_Contrasena->TextChanged += gcnew System::EventHandler(this, &EmpleadoMantenimientoEditar::TB_Contrasena_TextChanged);
			// 
			// L_Telefono
			// 
			...
			this->L_Telefono->Click += gcnew System::EventHandler(this, &EmpleadoMantenimientoEditar::L_Telefono_Click);
			// 
			// TB_Telefono
			// 
			...
			this->TB_Telefono->TextChanged += gcnew System::EventHandler(this, &EmpleadoMantenimientoEditar::TB_Telefono_TextChanged);
			// 
			// L_Genero
			// 
			...
			this->L_Genero->Click += gcnew System::EventHandler(this, &EmpleadoMantenimientoEditar::L_Genero_Click);
			// 
			// L_Edad
			// 
			...
			this->L_Edad->Click += gcnew System::EventHandler(this, &EmpleadoMantenimientoEditar::L_Edad_Click);
			// 
			// TB_Edad
			// 
			...
			this->TB_Edad->TextChanged += gcnew System::EventHandler(this, &EmpleadoMantenimientoEditar::TB_Edad_TextChanged);
			// 
			// L_DNI
			// 
			...
			this->L_DNI->Click += gcnew System::EventHandler(this, &EmpleadoMantenimientoEditar::L_DNI_Click);
			// 
			// TB_DNI
			// 
			...
			this->TB_DNI->TextChanged += gcnew System::EventHandler(this, &EmpleadoMantenimientoEditar::TB_DNI_TextChanged);
			// 
			// L_ApellidoMat
			// 
			...
			this->L_ApellidoMat->Click += gcnew System::EventHandler(this, &EmpleadoMantenimientoEditar::L_ApellidoMat_Click);
			// 
			// TB_ApellidoMat
			// 
			...
			this->TB_ApellidoMat->TextChanged += gcnew System::EventHandler(this, &EmpleadoMantenimientoEditar::TB_ApellidoMat_TextChanged);
			// 
			// L_ApellidoPat
			// 
			...
			this->L_ApellidoPat->Click += gcnew System::EventHandler(this, &EmpleadoMantenimientoEditar::L_ApellidoPat_Click);
			// 
			// TB_ApellidoPat
			// 
			...
			this->TB_ApellidoPat->TextChanged += gcnew System::EventHandler(this, &EmpleadoMantenimientoEditar::TB_ApellidoPat_TextChanged);
			// 
			// L_Nombres
			// 
			...
			this->L_Nombres->Click += gcnew System::EventHandler(this, &EmpleadoMantenimientoEditar::L_Nombres_Click);
			// 
			// TB_Nombres
			// 
			...
			this->TB_Nombres->TextChanged += gcnew System::EventHandler(this, &EmpleadoMantenimientoEditar::TB_Nombres_TextChanged);
			// 
			// L_Sueldo
			// 
			...
			this->L_Sueldo->Click += gcnew System::EventHandler(this, &EmpleadoMantenimientoEditar::L_Sueldo_Click);
			// 
			// TB_Sueldo
			// 
			...
			this->TB_Sueldo->TextChanged += gcnew System::EventHandler(this, &EmpleadoMantenimientoEditar::TB_Sueldo_TextChanged);
			// 
			// L_Contrato
			// 
			...
			this->L_Contrato->Click += gcnew System::EventHandler(this, &EmpleadoMantenimientoEditar::L_Contrato_Click);
			// 
			// TB_Contrato
			// 
			...
			this->TB_Contrato->TextChanged += gcnew System::EventHandler(this, &EmpleadoMantenimientoEditar::TB_Contrato_TextChanged);
			// 
			// B_Cancelar
			// 
			...
			this->B_Cancelar->Click += gcnew System::EventHandler(this, &EmpleadoMantenimientoEditar::B_Cancelar_Click_1);
			// 
			// B_Grabar
			// 
			...
			this->Text = L"EmpleadoMantenimientoEditar";
