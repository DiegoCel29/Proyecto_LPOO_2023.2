...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->B_Grabar->Location = System::Drawing::Point(-2, 492);
			...
			this->B_Cancelar->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->B_Cancelar->Location = System::Drawing::Point(348, 492);
			...
			this->L_Estado->Text = L"Descuento:";
...
#pragma endregion
	private: void CentrarForm() {
		...
		this->B_Grabar->Location = System::Drawing::Point(PosXGB_Datos, 510);
		this->B_Cancelar->Location = System::Drawing::Point(PosXGB_Datos + 350, 510);
	};
	...
	private: System::Void B_Grabar_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		String^ FechaPromocion = this->DTP_FechaPromocion->Text;
		int AforoPromocion = Convert::ToInt32(this->TB_Aforo->Text);
		double CantDescuento = Convert::ToDouble(this->TB_Descuento->Text);
		Paradero^ ParaderoAsociado = ObjParaderoController->buscarParaderoxCodigo(Convert::ToInt32(this->TB_Paradero->Text));
		bool Estado = Convert::ToBoolean(this->CB_Estado->Text);

		if ((Titulo !="") && (Descripcion != "") && (FechaPromocion != "") && (this->TB_Aforo->Text != "") && (this->TB_Descuento->Text != "") && (this->TB_Paradero->Text != "") && (this->CB_Estado->Text != "")) {
