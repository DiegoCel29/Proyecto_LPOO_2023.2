#pragma once
#include "FrmAgregarSituacionRecorrido.h"
#include "FrmEditarSituacionRecorrido.h"
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(212, 384);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(75, 23);
			this->button2->TabIndex = 2;
			this->button2->Text = L"Añadir";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &MantenimientoSituacionRecorrido::button2_Click);
			// 
			// button3
			// 
			this->button3->Location = System::Drawing::Point(485, 384);
			...
			// button4
			// 
			this->button4->Location = System::Drawing::Point(352, 384);
			this->button4->Name = L"button4";
			this->button4->Size = System::Drawing::Size(75, 23);
			this->button4->TabIndex = 4;
			this->button4->Text = L"Borrar";
			this->button4->UseVisualStyleBackColor = true;
			this->button4->Click += gcnew System::EventHandler(this, &MantenimientoSituacionRecorrido::button4_Click);
			// 
			// label1
			// 
			...
			this->dataGridView1->Size = System::Drawing::Size(543, 242);
...
#pragma endregion
	...
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		FrmAgregarSituacionRecorrido^ VentanaAgregarSituacionRecorrido = gcnew FrmAgregarSituacionRecorrido;
		VentanaAgregarSituacionRecorrido->ShowDialog();
	}
		   //Boton para eliminar
	private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		SituacionRecorridoController^ objetoSRecorridoController = gcnew SituacionRecorridoController;
		objetoSRecorridoController->EliminarRecorrido(codigoAeliminar);
		List<SituacionRecorrido^>^ listaSRecorridos = objetoSRecorridoController->buscarRecorridoall();
		mostrarGrilla(listaSRecorridos);
	}
	};
}
