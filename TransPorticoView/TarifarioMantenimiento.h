...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->L_ParaderoInicial->Location = System::Drawing::Point(13, 98);
			...
			this->CB_ParaderoInicial->SelectedIndexChanged += gcnew System::EventHandler(this, &TarifarioMantenimiento::CB_ParaderoInicial_SelectedIndexChanged);
			// 
			// L_Ruta
			// 
			...
			this->L_Ruta->Location = System::Drawing::Point(13, 37);
			...
			this->L_Tarifa->Location = System::Drawing::Point(13, 160);
			...
			this->DGV_Tarifario->Size = System::Drawing::Size(933, 369);
			...
			this->DGVC_Identificador->Width = 173;
			// 
			// DGVC_RutaAsociada
			// 
			...
			this->DGVC_RutaAsociada->Width = 176;
			// 
			...
			this->DGCV_ParaderoInicial->Width = 190;
			// 
			// DGVC_ParaderoFinal
			// 
			...
			this->DGVC_ParaderoFinal->Width = 174;
			// 
			// DGVC_Tarifa
			// 
			...
			this->ClientSize = System::Drawing::Size(1408, 820);
...
private: System::Void CB_ParaderoInicial_SelectedIndexChanged(System::Object^ sender, System::EventArgs^ e) {
}
};
}