...
namespace TransPorticoView {
	...
	public:
		...
		FrmEditarAutobuses(Autobus^ objetobus) {
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Click += gcnew System::EventHandler(this, &FrmEditarAutobuses::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &FrmEditarAutobuses::button1_Click);
			// 
			// textBox3
			// 
			...
			this->Text = L"Editar";
			this->Load += gcnew System::EventHandler(this, &FrmEditarAutobuses::FrmEditarAutobuses_Load);
...
private: System::Void FrmEditarAutobuses_Load(System::Object^ sender, System::EventArgs^ e) {
