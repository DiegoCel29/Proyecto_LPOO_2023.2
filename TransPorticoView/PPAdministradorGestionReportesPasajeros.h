...
namespace TransPorticoView {
	...
	/// <summary>
	/// Resumen de PPAdministradorGestionReportesPasajeros
	/// </summary>
	public ref class PPAdministradorGestionReportesPasajeros : public System::Windows::Forms::Form
	{
	public:
		PPAdministradorGestionReportesPasajeros(void)
		{
			InitializeComponent();
			//
	...
	protected:
		...
		/// </summary>
		~PPAdministradorGestionReportesPasajeros()
		{
			if (components)
			{
				delete components;
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(PPAdministradorGestionReportesPasajeros::typeid));
			...
			this->GB_Datos->Location = System::Drawing::Point(100, 64);
			...
			this->CB_Mostrar->Location = System::Drawing::Point(185, 54);
			this->CB_Mostrar->Name = L"CB_Mostrar";
			this->CB_Mostrar->Size = System::Drawing::Size(250, 32);
			...
			this->L_Paradero_Inicio->Location = System::Drawing::Point(10, 53);
			...
			this->B_Cancelar->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->B_Cancelar->Location = System::Drawing::Point(346, 292);
			...
			this->B_Grabar->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->B_Grabar->Location = System::Drawing::Point(194, 292);
			...
			this->ClientSize = System::Drawing::Size(656, 428);
			this->Controls->Add(this->B_Cancelar);
			this->Controls->Add(this->GB_Datos);
			this->Controls->Add(this->B_Grabar);
			this->DoubleBuffered = true;
			this->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->Name = L"PPAdministradorGestionReportesPasajeros";
