...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->groupBox1->Location = System::Drawing::Point(31, 20);
			this->groupBox1->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->groupBox1->Name = L"groupBox1";
			this->groupBox1->Padding = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->groupBox1->Size = System::Drawing::Size(362, 354);
			...
			this->button1->Location = System::Drawing::Point(125, 181);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(178, 127);
			...
			this->L_Ruta->Location = System::Drawing::Point(28, 245);
			this->L_Ruta->Name = L"L_Ruta";
			this->L_Ruta->Size = System::Drawing::Size(120, 30);
			...
			this->textBox3->Location = System::Drawing::Point(178, 245);
			...
			this->button2->Location = System::Drawing::Point(125, 300);
			...
			this->Logo->Location = System::Drawing::Point(259, 11);
			...
			this->ClientSize = System::Drawing::Size(422, 403);
			this->Controls->Add(this->groupBox1);
			this->DoubleBuffered = true;
			this->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->Name = L"SaldoPasajero";
			this->Text = L"SaldoPasajero";
			this->Load += gcnew System::EventHandler(this, &SaldoPasajero::SaldoPasajero_Load);
			this->SizeChanged += gcnew System::EventHandler(this, &SaldoPasajero::SaldoPasajero_SizeChanged);
...
#pragma endregion
	...
	private: System::Void SaldoPasajero_Load(System::Object^ sender, System::EventArgs^ e) {
		this->SizeChanged += (gcnew System::EventHandler(this, &SaldoPasajero::SaldoPasajero_SizeChanged));
		CentrarForm();
	}

	private: System::Void SaldoPasajero_SizeChanged(System::Object^ sender, System::EventArgs^ e) {
		CentrarForm();
	}
