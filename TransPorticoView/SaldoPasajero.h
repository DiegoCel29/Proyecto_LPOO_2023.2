...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->groupBox1->Location = System::Drawing::Point(47, 34);
			this->groupBox1->Name = L"groupBox1";
			this->groupBox1->Size = System::Drawing::Size(466, 326);
			...
			this->textBox3->Location = System::Drawing::Point(97, 154);
			...
			this->button2->Location = System::Drawing::Point(143, 234);
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Perpetua Titling MT", 18, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label1->Location = System::Drawing::Point(137, 97);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(122, 36);
			this->label1->TabIndex = 38;
			this->label1->Text = L"Saldo";
			this->label1->Click += gcnew System::EventHandler(this, &SaldoPasajero::label1_Click);
			// 
			// SaldoPasajero
			// 
			...
			this->ClientSize = System::Drawing::Size(540, 390);
